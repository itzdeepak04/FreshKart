...
function PageNotFound() {
    return (
        <div className="flex flex-col items-center justify-center text-sm max-md:px-4 mt-30">
            ...
            <div className="flex items-center gap-4 mt-6">
                <Link to={'/'} className="bg-primary hover:bg-primary-dull px-7 py-2.5 text-white rounded-md active:scale-95 transition-all">
                    Return Home
                </Link>
